...
var Buffer = (function () {
    ...
    Buffer.prototype = {
        ...
        /**
         * Возвращает JSON-представление буфера, которое соответствует массиву. Этот метод вызывается неявно, когда экземпля буфера передается в метод JSON.stringify.
         * @returns {Array}
         */
        toJSON: function () {
